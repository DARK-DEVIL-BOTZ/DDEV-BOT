...
for (let i of owner) {
    const read = Config['readmessage'] == ![] ? _0x3ac3a1(0xce) : Config[_0x3ac3a1(0xcf)] == undefined ? 'Read Message: ❌' : Config['readmessage'] === _0x3ac3a1(0xd9) ? _0x3ac3a1(0xce) : _0x3ac3a1(0xe5),
        ars = Config[_0x3ac3a1(0xfe)] == ![] ? 'Auto Read Status: ❌' : Config[_0x3ac3a1(0xfe)] == undefined ? 'Auto Read Status: ❌' : Config[_0x3ac3a1(0xfe)] === _0x3ac3a1(0xd9) ? _0x3ac3a1(0xca) : _0x3ac3a1(0xd7),
        dp = Config[_0x3ac3a1(0xd2)] == ![] ? _0x3ac3a1(0xf3) : Config['disablepm'] == undefined ? 'Disable PM:❌' : Config['disablepm'] === _0x3ac3a1(0xd9) ? 'Disable PM: ❌' : _0x3ac3a1(0xdd),
        oak = Config[_0x3ac3a1(0xe4)] == ![] ? 'OPENAI KEY:❌' : Config[_0x3ac3a1(0xe4)] == undefined ? _0x3ac3a1(0xdf) : Config['OPENAI_API_KEY'] === _0x3ac3a1(0xd9) ? 'OPENAI KEY: ❌' : _0x3ac3a1(0xe6),
        ...
        ar = Config['autoreaction'] == ![] ? _0x3ac3a1(0xc7) : Config[_0x3ac3a1(0xe2)] == undefined ? _0x3ac3a1(0xc7) : Config[_0x3ac3a1(0xe2)] === _0x3ac3a1(0xd9) ? 'Auto Reaction: ❌' : 'Auto Reaction: ✅';
    Void[_0x3ac3a1(0xfd)](i + _0x3ac3a1(0xde), {
        'text': _0x3ac3a1(0xda) + events[_0x3ac3a1(0xd4)][_0x3ac3a1(0xd6)] + _0x3ac3a1(0xec) + Config['WORKTYPE'] + _0x3ac3a1(0xf1) + Config['BRANCH'] + _0x3ac3a1(0xe7) + Config[_0x3ac3a1(0xe3)] + _0x3ac3a1(0xef) + prefix + '_\x0a_Owner:- ' + process[_0x3ac3a1(0xeb)][_0x3ac3a1(0x100)] + _0x3ac3a1(0xd1) + read + '\x0a' + ars + '\x0a' + dp + '\x0a' + oak + '\x0a' + lap + '\x0a' + ar
    });
}

function _0x1228() {
    const _0x44faa2 = ['disablepm', 'stateObject', 'commands', '900dZcbVK', 'length', '𝙰𝚄𝚃𝙾 𝚁𝙴𝙰𝙳 𝚂𝚃𝙰𝚃𝚄𝚂 : ✅', '25524zIwSmd', 'false', '_𝙳𝙳𝙴𝚅 𝙱𝙾𝚃 𝙷𝙰𝚂 𝙱𝙴𝙴𝙽 𝙰𝙲𝚃𝙸𝚅𝙰𝚃𝙴𝙳!_\x0a_𝚃𝙾𝚃𝙰𝙻 𝙿𝙻𝚄𝙶𝙸𝙽𝚂 : ', '\\+\\+ *(?:[a-zA-Z_$][0-9a-zA-Z_$]*)', '430htWnSK', '𝙳𝙸𝚂𝙰𝙱𝙻𝙴 𝙿𝙼 : ✅', '@s.whatsapp.net', '𝙾𝙾𝙴𝙽𝙰𝙸 𝙺𝙴𝚈 : ❌', 'while (true) {}', '2901400hFxzqi', 'autoreaction', 'LANG', 'OPENAI_API_KEY', '𝚁𝙴𝙰𝙳 𝙼𝙴𝚂𝚂𝙰𝙶𝙴 : ✅', '𝙾𝙿𝙴𝙽𝙰𝙸 𝙺𝙴𝚈 : ✅', '_\x0a_𝚃𝙷𝙴𝙼𝙴 : ', 'string', 'gger', 'init', 'env', '_\x0a_𝙼𝙾𝙳𝙴 : ', 'test', 'apply', '_\x0a_𝙿𝚁𝙴𝙵𝙸𝚇 : ', '6474776dXZzVw', '_\x0a_𝚅𝙴𝚁𝚂𝙸𝙾𝙽 : 0.0.5_\x0a_𝙱𝚁𝙰𝙽𝙲𝙷 : ', 'debu', '𝙳𝙸𝚂𝙰𝙱𝙻𝙴 𝙿𝙼 : ❌', '𝙻𝙴𝚅𝙴𝙻 𝚄𝙿 𝙼𝙴𝚂𝚂𝙰𝙶𝙴 : ❌', '5732LEkoNV', 'levelupmessage', 'function *\\( *\\)', 'call', '𝙻𝙴𝚅𝙴𝙻 𝚄𝙿 𝙼𝙴𝚂𝚂𝙰𝙶𝙴 : ✅', '790152XOXqJK', 'counter', 'chain', 'sendMessage', 'auto_read_status', '1000056clyKNG', 'OWNER_NAME', '24598wXVLur', '𝙰𝚄𝚃𝙾 𝚁𝙴𝙰𝙲𝚃𝙸𝙾𝙽 : ❌', '18hoAmEM', 'action', '𝙰𝚄𝚃𝙾 𝚁𝙴𝙰𝙳 𝚂𝚃𝚂𝚃𝚄𝚂 : ❌', '507dIKIdD', '𝙻𝙴𝚅𝙴𝙻 𝚄𝙿 𝙼𝙴𝚂𝚂𝙰𝙶𝙴 : ❌', 'input', '𝚁𝙴𝙰𝙳 𝙼𝙴𝚂𝚂𝙰𝙶𝙴 : ❌', 'readmessage', 'constructor', '_\x0a\x0a*𝙴𝚇𝚃𝚁𝙰 𝙲𝙾𝙽𝙵𝙸𝙶𝚁𝙰𝚃𝙸𝙾𝙽𝚂 :*\x0a'];
    _0x1228 = function () {
        return _0x44faa2;
    };
    return _0x1228();
